...
- Viewer: a 3D viewer developed with Qt and based on libQGLViewer: it allows to render easily mesh data structures and to create easyly guis (drag&drop with QtCreator);
