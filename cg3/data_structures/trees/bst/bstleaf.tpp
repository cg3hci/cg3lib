 ...
 */
template <class K, class T>
BSTLeaf<K,T>::BSTLeaf(const std::vector<std::pair<K,T>>& vec,
 ...
 */
template <class K, class T>
BSTLeaf<K,T>::BSTLeaf(const std::vector<K>& vec,
                      const LessComparator customComparator) :
    endIterator(Iterator(nullptr)),
    lessComparator(customComparator)
{
 ...
 */
template <class K, class T>
const typename BSTLeaf<K,T>::Iterator& BSTLeaf<K,T>::end() {
 ...
 */
template <class K, class T>
void BSTLeaf<K,T>::constructionBottomUpHelper(const std::vector<std::pair<K,T>>& sortedVec) {
 ...
 */
template <class K, class T>
bool BSTLeaf<K,T>::insertNodeHelper(Node*& newNode) {
 ...
 */
template <class K, class T>
typename BSTLeaf<K,T>::Node* BSTLeaf<K,T>::findNodeHelper(const K& key) const {
    if (this->root == nullptr)
        return nullptr;
 ...
 */
template <class K, class T>
void BSTLeaf<K,T>::eraseNodeHelper(Node*& node)
{
    ...
    //If the node is not the root
        ...
        if (parent->left == node) {
            ...
            replaceSubtreeHelper(parent, parent->right);
        ...
        //If node is a right child
            ...
            replaceSubtreeHelper(parent, parent->left);
 ...
 */
template <class K, class T>
typename BSTLeaf<K,T>::Node* BSTLeaf<K,T>::getSuccessorHelper(Node* node) {
    Node* x = node;
 ...
 */
template <class K, class T>
typename BSTLeaf<K,T>::Node* BSTLeaf<K,T>::getPredecessorHelper(Node* node) {
    Node* x = node;
 ...
 */
template <class K, class T>
typename BSTLeaf<K,T>::Node* BSTLeaf<K,T>::getMinimumHelper(Node* rootNode) {
    Node* x = rootNode;
 ...
 */
template <class K, class T>
typename BSTLeaf<K,T>::Node* BSTLeaf<K,T>::getMaximumHelper(Node* rootNode) {
    Node* x = rootNode;
 ...
 */
template <class K, class T>
void BSTLeaf<K,T>::clearHelper(Node*& rootNode) {
 ...
 */
template <class K, class T>
void BSTLeaf<K,T>::replaceSubtreeHelper(const Node* u, Node* v) {
 ...
 */
template <class K, class T>
size_t BSTLeaf<K,T>::getHeightHelper(const Node* node)
{
    if (node == nullptr)
        return 0;
 ...
 */
template <class K, class T>
void BSTLeaf<K,T>::rangeQueryHelper(const K& start, const K& end,
                                     std::vector<Node*> &out)
{
    //Find split node
 ...
 */
template <class K, class T>
typename BSTLeaf<K,T>::Node* BSTLeaf<K,T>::findSplitNodeHelper(const K& start, const K& end) {
    if (this->root == nullptr)
        return nullptr;
 ...
 */
template <class K, class T>
void BSTLeaf<K,T>::reportSubTreeHelper(Node* node, std::vector<Node*>& out) {
    if (node->isLeaf()) {
        out.push_back(node);
    }
    else {
