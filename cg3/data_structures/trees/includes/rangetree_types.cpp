 ...
 * (X component)
 */
bool point3DDimensionComparatorX(const Point3d& o1, const Point3d& o2)
{
    if (o1.x() < o2.x())
        return true;
    if (o2.x() < o1.x())
 ...
 * (Y component)
 */
bool point3DDimensionComparatorY(const Point3d& o1, const Point3d& o2)
{
    if (o1.y() < o2.y())
        return true;
    if (o2.y() < o1.y())
 ...
 * (Z component)
 */
bool point3DDimensionComparatorZ(const Point3d& o1, const Point3d& o2)
{
    if (o1.z() < o2.z())
        return true;
    if (o2.z() < o1.z())
