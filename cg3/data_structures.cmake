...
if (CG3_STATIC)
	...
	add_library(cg3-data-structures INTERFACE)
endif()

target_include_directories(cg3-data-structures ${CG3_TARGET_MOD} ${CG3_INCLUDE_DIR})

target_link_libraries(cg3-data-structures ${CG3_TARGET_MOD} cg3-core)
