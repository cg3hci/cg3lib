 ...
 */
inline BoundingBox2::BoundingBox2(const Point2d& min, const Point2d& max) :
    minCoord(min),
    maxCoord(max)
{
}
 ...
 */
inline const Point2d& BoundingBox2::min() const
{
    return minCoord;
}
 ...
 */
inline Point2d&BoundingBox2::min()
{
    return minCoord;
}
 ...
 * @param value
 */
inline void BoundingBox2::setMin(const Point2d& value)
{
    minCoord = value;
}
 ...
 */
inline const Point2d& BoundingBox2::max() const
{
    return maxCoord;
}
 ...
 */
inline Point2d& BoundingBox2::max()
{
    return maxCoord;
}
 ...
 * @param value
 */
inline void BoundingBox2::setMax(const Point2d& value)
{
    maxCoord = value;
}
 ...
 * @param max
 */
inline void BoundingBox2::set(const Point2d& min, const Point2d& max)
{
    minCoord = min;
    maxCoord = max;
}
 ...
 */
inline Point2d BoundingBox2::center() const
{
 ...
 */
inline double BoundingBox2::diag() const
{
 ...
 */
inline double BoundingBox2::lengthX() const
{
 ...
 */
inline double BoundingBox2::lengthY() const
{
 ...
 */
inline bool BoundingBox2::isInside(const Point2d& p) const
{
    return (p.x() >= minCoord.x() && p.y() >= minCoord.y() &&
            p.x() <= maxCoord.x() && p.y() <= maxCoord.y());
}

inline bool BoundingBox2::isStrictlyInside(const Point2d& p) const
{
    return (p.x() > minCoord.x() && p.y() > minCoord.y() &&
            p.x() < maxCoord.x() && p.y() < maxCoord.y());
}
 ...
 */
inline void BoundingBox2::serialize(std::ofstream& binaryFile) const
{
 ...
 * @see the SerializableObject Class
 */
inline void BoundingBox2::deserialize(std::ifstream& binaryFile)
{
...
//hash specialization
inline std::size_t std::hash<cg3::BoundingBox2>::operator()(const cg3::BoundingBox2 &k) const
{
    std::size_t h=0;
