...
/**
 * @brief Constructor, initializes the coordinates of the point
 *
 * @param x
 * @param y
 */
 ...
 */
template <class T>
inline const T& Point2<T>::x() const
{
    return xCoord;
}

/**
 * @brief Returns a const reference of the y coordinate.
 * @return a const reference of the y coordinate
 */
template <class T>
inline const T& Point2<T>::y() const
{
    return yCoord;
}

/**
 * @brief Calculates and returns the distance between this and otherPoint.
 *
 * @param[in] otherPoint: another point
 * @return the distance between this and otherPoint
 */
template <class T>
inline double Point2<T>::dist(const Point2<T> &otherPoint) const
{
...
/**
 * @brief Calculates and returns the dot product between this and otherVector.
 * @param[in] otherVector: another vector
 * @return the dot product between this and otherVector
 */
template <class T>
inline double Point2<T>::dot(const Point2<T> &otherVector) const
{
...
/**
 * @brief Calculates and returns the perpendicular dot product between this and otherVector.
 * @param[in] otherVector: another vector
 * @return the perpendicular dot product between this and otherVector
 */
template <class T>
inline double Point2<T>::perpendicularDot(const Point2<T>& otherVector) const
{
 ...
 */
template <class T>
inline double Point2<T>::length() const
{
 ...
 */
template <class T>
inline double Point2<T>::lengthSquared() const
{
 ...
 */
template <class T>
inline Point2<T> Point2<T>::min(const Point2<T> &otherPoint) const
{
    return Point2<T>(std::min(x(), otherPoint.xCoord),
 ...
 */
template <class T>
inline Point2<T> Point2<T>::max(const Point2<T> &otherPoint) const
{
    return Point2<T>(std::max(x(), otherPoint.xCoord),
 ...
 */
template <class T>
const T& Point2<T>::operator[](unsigned int i) const
{
    assert(i < 2);
    switch (i){
 ...
 */
template <class T>
inline bool Point2<T>::operator == (const Point2<T>& otherPoint) const
{
 ...
 */
template <class T>
Point2<T> Point2<T>::operator +(const T& scalar) const
{
    return Point2<T>(xCoord + scalar,
                      yCoord + scalar);
}
 ...
 */
template <class T>
inline Point2<T> Point2<T>::operator + (const Point2<T>& otherPoint) const
{
    return Point2(xCoord + otherPoint.xCoord,
...
{
    return Point2(xCoord * scalar, yCoord * scalar);
}
...
inline Point2<T> Point2<T>::operator * (const Point2<T>& otherPoint) const
{
    return Point2(xCoord * otherPoint.xCoord, yCoord * otherPoint.yCoord);
}
 ...
 */
template <class T>
inline void Point2<T>::setXCoord(const T& x)
{
    xCoord = x;
}
 ...
 */
template <class T>
inline void Point2<T>::setYCoord(const T& y)
{
    yCoord = y;
}
 ...
 */
template <class T>
inline double Point2<T>::normalize()
{
    double len = length();
    xCoord /= len;
    yCoord /= len;
 ...
 */
template <class T>
inline void Point2<T>::rotate(T matrix[][2], const Point2<T>& centroid)
{
    *this -= centroid;
    rot(matrix);
    *this += centroid;
 ...
 */
template <class T>
T& Point2<T>::operator[](unsigned int i)
{
    assert(i < 2);
    switch (i){
        case 0: return xCoord;
 ...
 */
template <class T>
inline Point2<T> Point2<T>::operator += (const Point2<T>& otherPoint)
{
 ...
 */
template <class T>
inline void Point2<T>::rot(T matrix[][2])
{
    Point2<T> p;
 ...
 */
template<class T>
void Point2<T>::serialize(std::ofstream& binaryFile) const
{
 ...
 */
template<class T>
void Point2<T>::deserialize(std::ifstream& binaryFile)
{
...
{
    return Point2<T>(point.x() * scalar,
                   point.y() * scalar);
}
 ...
 */
template <class T>
inline Point2<T> normalOfSegment(const Point2<T>& p1, const Point2<T>& p2)
{
 ...
 */
template <class T>
inline double area(const Point2<T>& p0, const Point2<T>& p1, const Point2<T>& p2)
{
...
//hash specialization
template<typename T>
inline std::size_t std::hash<cg3::Point2<T> >::operator()(const cg3::Point2<T> &k) const
{
    std::size_t h=0;
