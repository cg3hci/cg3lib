 ...
 * @param[out] m
 */
CG3_INLINE void rotationMatrix(Vec3 axis, double angle, Eigen::Matrix3d &m)
{
    axis.normalize();
 ...
 */
CG3_INLINE Eigen::Matrix3d rotationMatrix(Vec3 axis, double angle)
{
    Eigen::Matrix3d m;
    axis.normalize();
    double cosa = cos(angle);
 ...
 * @param[out] m
 */
CG3_INLINE void rotationMatrix(Vec3 axis, double angle, double m[][3])
{
    axis.normalize();
    double cosa = cos(angle);
    double sina = sin(angle);
